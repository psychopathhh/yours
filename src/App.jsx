...
const App = () => {
  ...
  return (
    <div className={`flex md:flex-row flex-col ${open && 'overflow-hidden'}`}>
      ...
      {activeSong?.title && (
        <div className={`absolute ${open ? `overflow-hidden h-[100%] flex-col animate-slideup rounded-3xl` : 'h-24 animate-slowfade rounded-t-3xl'} bg-[#293942] sm:h-32 bottom-[-10px] sm:bottom-0 left-0 right-0 flex z-40`}>
