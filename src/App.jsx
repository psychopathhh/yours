  ...
  return (
    <div className={`flex md:flex-row flex-col ${open && 'overflow-hidden'}`}>
      ...
      <div className="flex-1 flex flex-col bg-[#1b262c]">
        <div className={`px-6 h-[calc(100vh-56px)] overflow-y-scroll hide-scrollbar  ${open ? 'overflow-hidden invisible' : 'visible'}`}>
          <Searchbar />
      ...
      {activeSong?.title && (
        <div className={`absolute ${open ? `overflow-hidden h-[100%] flex-col animate-slideup` : 'h-24 animate-slowfade'} bg-[#293942] sm:h-32 bottom-[-10px] sm:bottom-0 left-0 right-0 flex z-40 rounded-3xl`}>
